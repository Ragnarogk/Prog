========================================================================
    KONSOLENANWENDUNG: aufg-002-scanf-Projektübersicht
========================================================================

Diese aufg-002-scanf-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre aufg-002-scanf-Anwendung besteht.


aufg-002-scanf.vcxproj
...
aufg-002-scanf.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen aufg-002-scanf.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
