========================================================================
    KONSOLENANWENDUNG: Taschenrechner 2.0-Projektübersicht
========================================================================

Diese Taschenrechner 2.0-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Taschenrechner 2.0-Anwendung besteht.


Taschenrechner 2.0.vcxproj
...
Taschenrechner 2.0.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Taschenrechner 2.0.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
