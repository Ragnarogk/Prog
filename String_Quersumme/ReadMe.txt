========================================================================
    KONSOLENANWENDUNG: String_Quersumme-Projektübersicht
========================================================================

Diese String_Quersumme-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre String_Quersumme-Anwendung besteht.


String_Quersumme.vcxproj
...
String_Quersumme.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen String_Quersumme.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
