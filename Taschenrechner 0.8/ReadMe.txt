========================================================================
    KONSOLENANWENDUNG: Taschenrechner 0.8-Projektübersicht
========================================================================

Diese Taschenrechner 0.8-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Taschenrechner 0.8-Anwendung besteht.


Taschenrechner 0.8.vcxproj
...
Taschenrechner 0.8.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Taschenrechner 0.8.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
