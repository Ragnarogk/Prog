========================================================================
    KONSOLENANWENDUNG: Ausgaben-Projektübersicht
========================================================================

Diese Ausgaben-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre Ausgaben-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Ausgaben.pch und eine 
