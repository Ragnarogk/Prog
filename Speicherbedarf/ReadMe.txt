========================================================================
    KONSOLENANWENDUNG: Speicherbedarf-Projektübersicht
========================================================================

Diese Speicherbedarf-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre Speicherbedarf-Anwendung besteht.


Speicherbedarf.vcxproj
...
Speicherbedarf.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Speicherbedarf.pch und eine 
