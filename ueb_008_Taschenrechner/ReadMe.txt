========================================================================
    KONSOLENANWENDUNG: ueb_008_Taschenrechner-Projektübersicht
========================================================================

Diese ueb_008_Taschenrechner-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre ueb_008_Taschenrechner-Anwendung besteht.


ueb_008_Taschenrechner.vcxproj
...
ueb_008_Taschenrechner.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen ueb_008_Taschenrechner.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
