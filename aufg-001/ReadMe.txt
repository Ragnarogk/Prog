========================================================================
    KONSOLENANWENDUNG: aufg-001-Projektübersicht
========================================================================

Diese aufg-001-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre aufg-001-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "aufg-001.pch und eine 
