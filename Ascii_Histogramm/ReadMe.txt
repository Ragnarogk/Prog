========================================================================
    KONSOLENANWENDUNG: Ascii_Histogramm-Projektübersicht
========================================================================

Diese Ascii_Histogramm-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Ascii_Histogramm-Anwendung besteht.


Ascii_Histogramm.vcxproj
...
Ascii_Histogramm.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Ascii_Histogramm.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
