========================================================================
    KONSOLENANWENDUNG: Konstanten-Projektübersicht
========================================================================

Diese Konstanten-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre Konstanten-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Konstanten.pch und eine 
